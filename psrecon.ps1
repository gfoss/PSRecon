...
<#
# Enable Logging
if ((Get-WmiObject win32_NTEventlogfile -filter "filename='PSRecon'") -ne $null) {
} Else {
    New-EventLog -LogName PSRecon -Source "LogRhythm Labs"
}
Write-EventLog -LogName PSRecon -Source "LogRhythm Labs" -EntryType Information -EventId 1337 -Message "Forensic Data Acquisition Initiated"
#>
